...
def log_time(start_time, end_time, seed, chain, base_path):
    ...
    # log_path = os.path.join(base_path, "inference_times_ex.log")
...
def main(pdbid):
    ...
    ligands_path = (
        f"{base_path}/Chemspace_Screening_Compounds_SMILES_sampled1M.smi"
    )
    # out_path_all = f"{base_path}/1M_all_ex.out"
